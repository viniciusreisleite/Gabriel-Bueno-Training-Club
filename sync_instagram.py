...
def main():
    ...
    for idx, reel_url in enumerate(reels_urls[:target_count], start=1):
        ...
        posts_data.append({
            ...
            "caption": caption.strip() if caption else "Gabriel Bueno Training Club - Treinamento de alta performance e evolução contínua.",
    ...
    print("\n✅ Concluído! Vídeos do Studio Fit comprimidos em 720p e salvos.")
